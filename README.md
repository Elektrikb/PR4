...
## Запуск игры
Для запуска игры сначала запустите сервер, затем несколько экземпляров клиента. Игроки по очереди будут пытаться угадать секретный код, получая обратную связь в виде черных и белых маркеров.
